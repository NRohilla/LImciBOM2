...
- Allows to export the computed informations to integrate with React and Comments view libraries;
...
Integrating 3rd party libraries in React or Comments libraries can be a pain because
