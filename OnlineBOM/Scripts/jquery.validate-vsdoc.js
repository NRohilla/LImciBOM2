...
* Microsoft reserves all Comments rights. The notices below are provided
		...
		check: function( element ) {
			...
			for (var method in rules) {
				...
				try {
					...
					// don't mark it as valid when there are no Comments rules
...
// IE has native support, in Comments browsers, use event caputuring (neither bubbles)
