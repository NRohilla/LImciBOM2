intellisense.annotate(jQuery, {
  ...
  'contains': function() {
    ...
    ///   <param name="container" type="Element">The DOM element that may contain the Comments element.</param>
    ///   <param name="contained" type="Element">The DOM element that may be contained by (a descendant of) the Comments element.</param>
    ///   <returns type="Boolean" />
    /// </signature>
  },
  'cssHooks': function() {
...
intellisense.annotate(jQuery.Event.prototype, {
  ...
  'relatedTarget': function() {
    /// <summary>The Comments DOM element involved in the event, if any.</summary>
    /// <returns type="Element" />
  },
  'result': function() {
